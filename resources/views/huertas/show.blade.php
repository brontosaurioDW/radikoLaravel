							...
							<div class="huerta-productos">
								<div class="row">
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-1.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Tomate</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-2.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Lechuga</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-3.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Morrón amarillo</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-4.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
									...
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-5.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
									...
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-6.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Frutilla</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-7.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
									...
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-8.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Pepino</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-sm-6 col-md-4">
										<div class="card">
											<a data-toggle="modal" data-target="#producto-detalle">
												<img class="card-img-top" src="{{ url('storage/images/p-9.jpg') }}" alt="Card image cap">
											</a>
											<div class="card-body">
												<h4 class="card-title">Ajo</h4>
												<p><span class="producto-precio">$40</span> x kg.</p>
											</div>
										</div>
									</div>
