...
@if (count(Cart::content()) != 0)
  <section class="huerta-title-wrapper" style="margin-top: 100px;">
            ...
            <li>
              <div class="row align-items-center">
                ...
                <div class="col-md-2 text-center">
                  <a href='{{url("carrito?product_id=$row->id&borrar=1")}}' onclick="return ConfirmarBorrado();"> Borrar </a>
                </div>
          ...
          <div class="continue">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="text-right">
                ...
                <a href="{{url("carrito?vaciar=1")}}"  onclick="return ConfirmarBorrado();">Vaciar chango</a>
